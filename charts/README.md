...
**Not Helm:** first-party cluster manifests (cert-manager CRs, media PV/PVC, ingress, gateways) live under **`deploy/kustomize/base/`** and apply with **`kubectl apply -k deploy/kustomize/base`** — see **`deploy/kustomize/README.md`**.
